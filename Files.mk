...
LUAFFIFB_CFLAGS = -I . -I lua/ -I luaffifb/ -I libffi/src/wasm/include -I libffi/src/wasm -DCALL_WITH_LIBFFI
...
# but I don't like that i've got two emscripten FS objects ... would be nice to build it directly into mine ...
